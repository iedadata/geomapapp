...
public class XMBorder {
	...
	public XMBorder(XMImage line) {
		this.line = line;
		font = new Font("SansSerif", Font.PLAIN, 10);
		titleFont = new Font("SansSerif", Font.PLAIN, 12);
		title = line.getCruiseID() +", Line "+ line.getID() +", CMP#";
		yTitle = "2-way time, sec";
		setTitleSize();
		setAnotSize();
	}
...
//		***** GMA 1.6.2: Label for x-axis changed from "Shot#" to "CMP#"
		title = line.getCruiseID() +" Line "+ line.getID() +", CMP#";
	...
	//If the file is a radar file the time should be in microseconds
	public void setYTitle(String s){
		if(s.equalsIgnoreCase("radar")) {
