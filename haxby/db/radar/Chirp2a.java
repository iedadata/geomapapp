...
public class Chirp2a extends JComponent implements ActionListener, MouseMotionListener {
	int lineNumber;
...
//	short[][][] traces2;
	...
	JLabel yLabel;
	JLabel zLabel;
	public Chirp2a( File file ) throws IOException {
		xLabel = new JLabel("x");
		yLabel = new JLabel("y");
		zLabel = new JLabel("z");
		this.file = file;
...
*/
	...
	public static void main(String[] args) {
		if(args.length != 1 && args.length != 2) {
			System.out.println("usage: java Chirp2a filename [samples_per_trace]");
			System.exit(0);
		}
		if( args.length==2 ) SAMPLES_PER_TRACE = Integer.parseInt( args[1] );
		try {
			Chirp2a segy = new Chirp2a( new File(args[0]) );
			System.out.println( "Chirp2a Object created");
