...
public class SpreadingRate_Tiler {
	public static void main(String[] args) throws IOException {
		if (args.length < 2) {
			System.err.println("Ussage: SpreadingRate_Tiler spreadingRate_grid.grd outputDirectory [# of levels to Tile]");
			System.err.println(" spreadingRate_grid must be a GMT v3 or v4 grid with lon range from -180 to 180");
			System.exit(-1);
		}
