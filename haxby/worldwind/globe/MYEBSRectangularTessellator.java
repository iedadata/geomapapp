 ...
 */
public class MYEBSRectangularTessellator extends WWObjectImpl implements Tessellator
{
    ...
    {
        protected final MYEBSRectangularTessellator tessellator; // not needed if not a static class
        ...
        public RectTile( MYEBSRectangularTessellator tessellator, Extent extent, int level, int density, Sector sector,
            double cellSize)
        {
        ...
        public MYEBSRectangularTessellator getTessellator()
        {
            return tessellator;
        }
    ...
    protected static final String CACHE_ID = MYEBSRectangularTessellator.class.getName();
    ...
    protected MYEBSRectangularTessellator.CacheKey createCacheKey(DrawContext dc, RectTile tile)
    {
...
//        Vec4 tR = new Vec4(a[3], a[4], a[5]);
    ...
    public Sector getCurrentCoverage() // add samantha
    {
