...
public class OceanAgesSurfaceLayer extends BasicScalingTiledImageLayer 
									implements ColorScale,
										InfoSupplier {//TiledImageLayer {
	
	private static final Palette inversePalette = new Palette(6);
	static {
		inversePalette.setRange(0, 280);
	}
	
	public static final String BASE_URL = WWMapApp.VO_BASE_URL + "data/tiles/geographic/ocean_ages_512/";
	
	public OceanAgesSurfaceLayer() {
		super(makeLevels());
