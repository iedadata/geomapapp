...
public class SpreadingAsymmetrySurfaceLayer extends BasicScalingTiledImageLayer 
									implements ColorScale,
										InfoSupplier {//TiledImageLayer {
	
	private static final Palette rainbowPallete = new Palette(5);
	static {
		rainbowPallete.setRange(0, 110);
	}
	
	public static final String BASE_URL = WWMapApp.VO_BASE_URL + "data/tiles/geographic/spreading_asymmetry_512/";
	
	public SpreadingAsymmetrySurfaceLayer() {
		super(makeLevels());
