...
/**
 * @author tag
 * @version $Id: BasicTiledImageLayer.java 857 2012-10-18 17:58:22Z tgaskins $
 * @version $Id: BasicTiledImageLayer.java 1171 2013-02-11 21:45:02Z dcollins $
 */
public class BasicScalingTiledImageLayer extends ScalingTiledImageLayer implements BulkRetrievable
{
	//protected
...
//	protected static final int SERVICE_CAPABILITIES_RESOURCE_ID = 1;
	...
	public BasicScalingTiledImageLayer(LevelSet levelSet)
	{
		super(levelSet);
	}

	public BasicScalingTiledImageLayer(AVList params)
	{
...
//this.setSplitScale(d);
	...
	public BasicScalingTiledImageLayer(Document dom, AVList params)
	{
		this(dom.getDocumentElement(), params);
	}

	public BasicScalingTiledImageLayer(Element domElement, AVList params)
	{
	...
	{
		private final BasicScalingTiledImageLayer layer;
		private final TextureTile tile;

		private RequestTask(TextureTile tile, BasicScalingTiledImageLayer layer)
		{
			this.layer = layer;
			this.tile = tile;
		}
...
*/
	protected static class DownloadPostProcessor extends AbstractRetrievalPostProcessor //implements RetrievalPostProcessor
	{
		...
		public DownloadPostProcessor(TextureTile tile, BasicScalingTiledImageLayer layer)
		{
...
protected void initFromOGCCapabilitiesResource(WMSCapabilities caps, AVList params)
{
    ...
    SwingUtilities.invokeLater(new Runnable()
    {
        public void run()
        {
            BasicScalingTiledImageLayer.this.setExpiryTime(expiryTime);
            BasicScalingTiledImageLayer.this.firePropertyChange(AVKey.LAYER, null, BasicScalingTiledImageLayer.this);
        }
    });
}
