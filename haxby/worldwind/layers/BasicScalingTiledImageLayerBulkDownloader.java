...
//    }
    ...
    protected BasicScalingTiledImageLayer.DownloadPostProcessor createBulkDownloadPostProcessor(TextureTile tile)
    {
        return new BulkDownloadPostProcessor(tile, this.layer, this.fileStore);
    }

    protected class BulkDownloadPostProcessor extends BasicScalingTiledImageLayer.DownloadPostProcessor
    {
