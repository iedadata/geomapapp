 ...
 */
public class SunCompassLayer extends AbstractLayer
{
    protected String iconFilePath = "images/notched-compass.dds"; // TODO: make configurable
    protected double compassToViewportScale = 0.07; // TODO: make configurable
    ...
    protected SunAngle angleSupplier;
    ...
    public void setAngleSupplier(SunAngle angleSupplier) {
        ...
        try
        {
            ...
            if (!dc.isPickingMode())
            {
                ...
                if (angleSupplier != null && 
					angleSupplier.getSunAngle() != null &&
					!Double.isNaN(angleSupplier.getSunAngle())) {
				gl.glDisable(GL.GL_TEXTURE_2D);
				
				gl.glTranslated(.5, .5, 0);
				gl.glRotated(-angleSupplier.getSunAngle(), 0, 0, 1);
				gl.glTranslated(-.5, -.5, 0);
				
				gl.glColor4d(1d, 1d, 0d, this.getOpacity());
				...
				gl.glColor4d(0d, 0d, 0d, this.getOpacity());
    ...
    public static interface SunAngle {
