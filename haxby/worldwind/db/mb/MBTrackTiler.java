...
public class MBTrackTiler extends AbstractTrackTiler {

	private final Object fileLock = new Object();
	
	protected Vector cruises; // MBTrack
	
	public MBTrackTiler(Vector cruises)
	{
...
//		g.translate(-tileBounds.getX(), -tileBounds.getY());
		...
		for (Object cruise : cruises)
		{
			if (cruise == null) continue;
			
			MBTrack[] tracks = ((MBCruise)cruise).getTracks();
			
			for (MBTrack track : tracks)
			{
