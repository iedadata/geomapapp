...
import static haxby.image.jcodec.common.Codec.*;
import static haxby.image.jcodec.common.Format.*;
import static haxby.image.jcodec.common.io.NIOUtils.writableFileChannel;
...
import haxby.image.jcodec.codecs.h264.encode.CQPRateControl;
import haxby.image.jcodec.codecs.png.PNGEncoder;
import haxby.image.jcodec.codecs.prores.ProresEncoder;
import haxby.image.jcodec.codecs.raw.RAWVideoEncoder;
import haxby.image.jcodec.codecs.vpx.IVFMuxer;
import haxby.image.jcodec.codecs.vpx.VP8Encoder;
import haxby.image.jcodec.codecs.wav.WavMuxer;
import haxby.image.jcodec.codecs.y4m.Y4MMuxer;
import haxby.image.jcodec.common.AudioCodecMeta;
import haxby.image.jcodec.common.AudioEncoder;
...
import haxby.image.jcodec.common.VideoEncoder.EncodedFrame;
...
import haxby.image.jcodec.containers.imgseq.ImageSequenceMuxer;
import haxby.image.jcodec.containers.mkv.muxer.MKVMuxer;
import haxby.image.jcodec.containers.mp4.muxer.CodecMP4MuxerTrack;
import haxby.image.jcodec.containers.mp4.muxer.MP4Muxer;
import haxby.image.jcodec.containers.mp4.muxer.MP4MuxerTrack;
import haxby.image.jcodec.containers.raw.RawMuxer;
...
public class SinkImpl implements Sink, PacketSink {
    ...
    public void outputVideoFrame(VideoFrameWithPacket videoFrame) throws IOException {
        ...
        outputVideoPacket(outputVideoPacket, haxby.image.jcodec.common.VideoCodecMeta
    ...
    public void outputAudioFrame(AudioFrameWithPacket audioFrame) throws IOException {
        ...
        outputAudioPacket(Packet.createPacketWithData(audioFrame.getPacket(), encodeAudio(audioFrame.getAudio())),
                haxby.image.jcodec.common.AudioCodecMeta.fromAudioFormat(audioFrame.getAudio().getFormat()));
    }
