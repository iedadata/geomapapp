...
import static haxby.image.jcodec.common.Codec.MPEG4;
import static haxby.image.jcodec.common.Codec.PCM;
import static haxby.image.jcodec.common.Codec.PNG;
import static haxby.image.jcodec.common.Codec.PRORES;
...
import static haxby.image.jcodec.common.io.NIOUtils.readableFileChannel;
...
import haxby.image.jcodec.codecs.mjpeg.JpegToThumb2x2;
import haxby.image.jcodec.codecs.mjpeg.JpegToThumb4x4;
import haxby.image.jcodec.codecs.mpeg12.MPEGDecoder;
import haxby.image.jcodec.codecs.mpeg12.Mpeg2Thumb2x2;
import haxby.image.jcodec.codecs.mpeg12.Mpeg2Thumb4x4;
import haxby.image.jcodec.codecs.mpeg4.MPEG4Decoder;
import haxby.image.jcodec.codecs.png.PNGDecoder;
import haxby.image.jcodec.codecs.prores.ProresDecoder;
import haxby.image.jcodec.codecs.prores.ProresToThumb;
import haxby.image.jcodec.codecs.prores.ProresToThumb2x2;
import haxby.image.jcodec.codecs.prores.ProresToThumb4x4;
import haxby.image.jcodec.codecs.raw.RAWVideoDecoder;
...
import haxby.image.jcodec.common.Tuple._3;
...
import haxby.image.jcodec.containers.mp4.demuxer.MP4DemuxerTrackMeta;
...
import haxby.image.jcodec.containers.mps.MPEGDemuxer.MPEGDemuxerTrack;
...
public class SourceImpl implements Source, PacketSource {
    ...
    private static class RawAudioDecoder implements AudioDecoder {
        ...
        public AudioCodecMeta getCodecMeta(ByteBuffer data) throws IOException {
            return haxby.image.jcodec.common.AudioCodecMeta.fromAudioFormat(format);
        }
    }
