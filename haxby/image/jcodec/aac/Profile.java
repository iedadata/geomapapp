 ...
 * 
 * Different AAC profiles. The function <code>Decoder.canDecode</code> specifies
 * if the decoder can handle a given format. More precisely, the ISO standard
 * calls these 'object types'.
 * 
 * @author in-somnia
 */
public final class Profile {
    ...
    /**
     * Returns a profile instance for the given index. If the index is not between 1
     * and 23 inclusive, UNKNOWN is returned.
     * 
    ...
    /**
     * Returns a string representation of this profile. The method is identical to
     ...
     * That is, if it's index is higher than 16, since the first error resilient
     * profile is ER_AAC_LC (17). This method is mainly used internally.
     * 
