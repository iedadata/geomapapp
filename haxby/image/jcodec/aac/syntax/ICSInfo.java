...
import static haxby.image.jcodec.aac.Profile.*;
import static haxby.image.jcodec.aac.syntax.ScaleFactorBands.*;
...
import haxby.image.jcodec.aac.tools.ICPrediction;
...
public class ICSInfo {
    public static class LTPrediction implements SyntaxConstants {
        ...
        public static boolean isLTPProfile(Profile profile) {
            return profile.equals(Profile.AAC_LTP) || profile.equals(Profile.ER_AAC_LTP)
                    || profile.equals(Profile.AAC_LD);
        }
