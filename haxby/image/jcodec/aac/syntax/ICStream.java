...
import static haxby.image.jcodec.aac.huffman.HCB.*;
import static haxby.image.jcodec.aac.syntax.IQTable.*;
import static haxby.image.jcodec.aac.syntax.ScaleFactorTable.*;
import static haxby.image.jcodec.aac.syntax.SyntaxConstants.*;
...
import haxby.image.jcodec.aac.error.RVLC;
import haxby.image.jcodec.aac.gain.GainControl;
import haxby.image.jcodec.aac.huffman.HCB;
import haxby.image.jcodec.aac.huffman.Huffman;
import haxby.image.jcodec.aac.tools.TNS;
...
public class ICStream {
    ...
    public void decode(BitReader _in, boolean commonWindow, AACDecoderConfig conf) throws AACException {
        ...
        // RVLC spectral data
        // if(conf.isScalefactorResilienceUsed()) rvlc.decodeScalefactors(this, _in,
        // scaleFactors);
     ...
     * After this the noiseless decoding is finished and the decoded data is
     * returned.
     * 
