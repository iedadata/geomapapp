...
public class Probabilities {
    ...
    private static final int[][] default_partition_probs = new int[][] {
            // 8x8 -> 4x4
    ...
    private static final int[][][] default_tx_probs = new int[][][] { { { 0, 0, 0 }, { 0, 0, 0 } },
            { { 100, 0, 0 }, { 66, 0, 0 } }, { { 20, 152, 0 }, { 15, 101, 0 } }, { { 3, 136, 37 }, { 5, 52, 13 } } };

    public static final int[] default_is_inter_probs = new int[] { 9, 102, 187, 225 };

    public static final int[][][] kf_y_mode_probs = new int[][][] { { // above =
                                                                      // dc
    ...
    public static final int[][] kf_uv_mode_probs = new int[][] { { 144, 11, 54, 157, 195, 130, 46, 58, 108 }, // y
                                                                                                              // =
                                                                                                              // dc
    ...
    public static final int[][] default_y_mode_probs = new int[][] { { 65, 32, 18, 144, 162, 194, 41, 51, 98 }, // block_size
                                                                                                                // <
                                                                                                                // 8x8
    ...
    public static final int[][] default_uv_mode_probs = new int[][] { { 120, 7, 76, 176, 208, 126, 28, 54, 103 }, // y
                                                                                                                  // =
                                                                                                                  // dc
    ...
    public static final int[][] default_single_ref_prob = new int[][] { { 33, 16 }, { 77, 74 }, { 142, 142 },
            { 172, 170 }, { 238, 247 } };

    public static final int[] default_comp_ref_prob = new int[] { 50, 126, 123, 221, 226 };

    public static final int[][] default_interp_filter_probs = new int[][] { { 235, 162 }, { 36, 255 }, { 34, 3 },
            { 149, 144 } };

    public static final int[][] default_inter_mode_probs = new int[][] { { 2, 173, 34 }, { 7, 145, 85 }, { 7, 166, 63 },
            { 7, 94, 66 }, { 8, 64, 46 }, { 17, 81, 31 }, { 25, 29, 30 }, };
    public static final int[] default_mv_joint_probs = new int[] { 32, 64, 96 };

    public static final int[][] default_mv_bits_prob = new int[][] {
    ...
    public static final int[][][][][][] coef_probs = new int[][][][][][] {
            { { /* block Type 0 */
                    { /* Intra */
                            { /* Coeff Band 0 */
