...
import static haxby.image.jcodec.codecs.png.IHDR.PNG_COLOR_MASK_ALPHA;
import static haxby.image.jcodec.codecs.png.IHDR.PNG_COLOR_MASK_COLOR;
import static haxby.image.jcodec.codecs.png.IHDR.PNG_COLOR_MASK_PALETTE;
...
import static haxby.image.jcodec.codecs.png.PNGConsts.TAG_PLTE;
import static haxby.image.jcodec.codecs.png.PNGConsts.TAG_tRNS;
    ...
    public VideoCodecMeta getCodecMeta(ByteBuffer _data) {
        ...
        while (data.remaining() >= 8) {
            ...
            case TAG_IHDR:
                IHDR ihdr = new IHDR();
                ihdr.parse(data);
                return haxby.image.jcodec.common.VideoCodecMeta.createSimpleVideoCodecMeta(new Size(ihdr.width, ihdr.height), ColorSpace.RGB);
            default:
                data.position(data.position() + length + 4);
            }
        }
