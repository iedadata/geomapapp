...
import static haxby.image.jcodec.codecs.aac.ObjectType.AOT_ESCAPE;
...
public class AACUtils {
    ...
    public static haxby.image.jcodec.codecs.aac.ADTSParser.Header streamInfoToADTS(ByteBuffer si, boolean crcAbsent,
