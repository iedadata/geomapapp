package haxby.image.jcodec.containers.mxf;

import static haxby.image.jcodec.containers.mxf.model.UL.newUL;

import java.nio.ByteBuffer;
import java.util.HashMap;
import java.util.Map;

import haxby.image.jcodec.containers.mxf.model.AES3PCMDescriptor;
import haxby.image.jcodec.containers.mxf.model.CDCIEssenceDescriptor;
import haxby.image.jcodec.containers.mxf.model.ContentStorage;
import haxby.image.jcodec.containers.mxf.model.EssenceContainerData;
import haxby.image.jcodec.containers.mxf.model.FileDescriptor;
import haxby.image.jcodec.containers.mxf.model.GenericDataEssenceDescriptor;
import haxby.image.jcodec.containers.mxf.model.GenericDescriptor;
import haxby.image.jcodec.containers.mxf.model.GenericPictureEssenceDescriptor;
import haxby.image.jcodec.containers.mxf.model.GenericSoundEssenceDescriptor;
import haxby.image.jcodec.containers.mxf.model.Identification;
import haxby.image.jcodec.containers.mxf.model.IndexSegment;
import haxby.image.jcodec.containers.mxf.model.J2KPictureDescriptor;
import haxby.image.jcodec.containers.mxf.model.MPEG2VideoDescriptor;
import haxby.image.jcodec.containers.mxf.model.MXFMetadata;
import haxby.image.jcodec.containers.mxf.model.MXFPartitionPack;
import haxby.image.jcodec.containers.mxf.model.MaterialPackage;
import haxby.image.jcodec.containers.mxf.model.Preface;
import haxby.image.jcodec.containers.mxf.model.RGBAEssenceDescriptor;
import haxby.image.jcodec.containers.mxf.model.Sequence;
import haxby.image.jcodec.containers.mxf.model.SourceClip;
import haxby.image.jcodec.containers.mxf.model.SourcePackage;
import haxby.image.jcodec.containers.mxf.model.TimecodeComponent;
import haxby.image.jcodec.containers.mxf.model.TimelineTrack;
import haxby.image.jcodec.containers.mxf.model.UL;
import haxby.image.jcodec.containers.mxf.model.WaveAudioDescriptor;
