...
public class GrainXYGraph extends JComponent
			implements Zoomable,
				Printable,
				Scrollable	{
	XYPoints xy;
	...
	public GrainXYGraph( XYPoints pts, int dataIndex ) {
...
//		System.out.println("xRange[0]: " + xRange[0] + " xRange[1]: " + xRange[1] + " yRange[0]: " + yRange[0] + " yRange[1]: " + yRange[1]);
		xRange[0] = 0.0;
		xRange[1] = 100.0;
		...
		int sides = Axes.LEFT | Axes.BOTTOM |Axes.RIGHT;
...
//		System.out.println("bounds.x: " + bounds.x + " bounds.y: " + bounds.y);
//		bounds = new Rectangle2D.Double( 0.0, bounds.y, 100.0, bounds.height );
		...
		//	}
			...
			public void mouseDragged(MouseEvent e) {
				if( canDigitize() ) {
					...
					System.out.println("canDigitize()");
