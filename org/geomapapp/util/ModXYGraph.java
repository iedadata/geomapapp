...
public class ModXYGraph extends JComponent
			implements Zoomable,
				Printable,
				Scrollable	{
	XYPoints xy;
...
//	***** GMA 1.6.8: Add additional set of data points
	int dataIndex2;
//	***** GMA 1.6.8	

	public ModXYGraph( XYPoints pts, int dataIndex ) {
	...
	public void setPoints( XYPoints pts, int dataIndex ) {
		...
		int sides = ModAxes.LEFT | ModAxes.BOTTOM |ModAxes.RIGHT | ModAxes.TOP;
		if( axes != null ) sides = axes.sides;
		axes = new ModAxes( xy, dataIndex,  sides);
...
//			return yRange[1] - (p.getY()-(double)insets.top) / (yScale*zoom);
	...
	public void paintComponent( Graphics graphics ) {
		...
		xy.plotXY( g, bounds, sX, sY, dataIndex2 );
	}
